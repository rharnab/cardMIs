        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <!-- for Cib information  -->
                     <li  class="active dropdown"><a class="dropdown-toggle" data-toggle="dropdown"  href="#"><i class="fa fa-angle-double-right"></i>CIB Informatione <b class="caret pull-right" style="margin-top: 10px;  margin-right: 8px;"></b></a>
                        <ul class="dropdown-menu" style="background-color: gainsboro; width: 100%;">
                            <li class="dropdown dropdown-submenu">
                                <a href="/cardMis/pages/card/cib/import_subject.php" class="dropdown-toggle">&nbsp;&nbsp;
                                     <i class="fa fa-circle-o" aria-hidden="true"></i> Import MIS FILE
                                 </a>
                            </li>

                             <li class="dropdown dropdown-submenu">
                                <a href="/cardMis/pages/card/cib/import_contracts.php" class="dropdown-toggle">&nbsp;&nbsp;
                                     <i class="fa fa-circle-o" aria-hidden="true"></i> IMPORT CL FILE
                                 </a>
                            </li> 
                             <li class="dropdown dropdown-submenu">
                                <a href="/cardMis/pages/card/cib/generate_cib.php" class="dropdown-toggle">&nbsp;&nbsp;
                                     <i class="fa fa-circle-o" aria-hidden="true"></i> Generate CIB
                                 </a>
                            </li>

                             <li class="dropdown dropdown-submenu">
                                <a href="/cardMis/pages/card/cib/download_cib.php" class="dropdown-toggle">&nbsp;&nbsp;
                                     <i class="fa fa-circle-o" aria-hidden="true"></i> DOWNLOAD CIB
                                 </a>
                            </li> 
                             <li class="dropdown dropdown-submenu">
                                <a href="/cardMis/pages/card/cib/modify_subject.php" class="dropdown-toggle">&nbsp;&nbsp;
                                     <i class="fa fa-circle-o" aria-hidden="true"></i> MODIFY SUBJECT
                                 </a>
                            </li>

                             <li class="dropdown dropdown-submenu">
                                <a href="/cardMis/pages/card/cib/modify_contract.php" class="dropdown-toggle">&nbsp;&nbsp;
                                     <i class="fa fa-circle-o" aria-hidden="true"></i> MODIFY CONTRACTS
                                 </a>
                            </li> 
                        </ul>
                     </li>
                      <!-- for for Cib information -->


                        <!-- for card charge  -->
                     <li  class="active dropdown"><a class="dropdown-toggle" data-toggle="dropdown"  href="#"><i class="fa fa-angle-double-right"></i>CHARGE <b class="caret pull-right" style="margin-top: 10px;  margin-right: 8px;"></b></a>
                        <ul class="dropdown-menu" style="background-color: gainsboro; width: 100%;">
                            <li class="dropdown dropdown-submenu">
                                <a href="/cardMis/pages/card/card_charge/chargeFileUpload.php" class="dropdown-toggle">&nbsp;&nbsp;
                                     <i class="fa fa-circle-o" aria-hidden="true"></i> Import CHARGE FILE
                                 </a>
                            </li>

                             <li class="dropdown dropdown-submenu">
                                <a href="/cardMis/pages/card/card_charge/card_charge.php" class="dropdown-toggle">&nbsp;&nbsp;
