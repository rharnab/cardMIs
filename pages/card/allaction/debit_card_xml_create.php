<?php
	...
	$sl_debit_card_api = $conn->prepare("SELECT * FROM debit_card_api WHERE card_status !='dishonour' AND card_status !=''");
	...
	$select = $conn->prepare("SELECT * FROM debit_card_api WHERE card_status !='dishonour' AND card_status !=''");
	$select->execute();
	while($row = $select->fetch(PDO::FETCH_OBJ)){
		...
		if($insert_backup->execute()){
			...
			$delete_api_data = $conn->prepare("DELETE FROM debit_card_api WHERE id=?");
