...
<html>
    <head>
     ...
     <script>
        // selectOptionDetails= tableNAme$AB$MatchCol***matchColVal
        function showUploadWiseStmt(uplDate){
    ...
    <body class="skin-blue">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="left: 0px; top: 0px">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form action="core/xmlParse.php" method="post" name="info" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <br> 
                                    ...
                                    <div class="box-footer">
                                        <button id="xmluploadBtn" type="" name="submit" class="btn btn-primary">Submit</button>
                                    </div>
                                </form>
                            </div><!-- /.box -->
        ...
        <script>
            ...
            $(document).on('click',"#xmluploadBtn",function(e){
                e.preventDefault();
                var file = $("#fileToUpload").val();
                var extension = file.substr( (file.lastIndexOf('.') +1));
                var actionAttr = $('form').attr('action');
                //core/xmlParse.php fileToUpload //
                if(extension == 'xml'){
                    $("form").attr('action','core/xmlParse.php');
                    console.log(file);
                }else{
                    alert("Please take xml file");
