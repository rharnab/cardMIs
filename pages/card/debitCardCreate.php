                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="otherPhone" name="otherPhone" placeholder="Enter other phone number" class="form-control">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="otherEmail" name="otherEmail" placeholder="Enter other email" class="form-control">
