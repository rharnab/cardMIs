                            ...
                            <div class="box">
                               <div class="box-header">
                                ...
                                <div class="box-body">
                                  <!-- from -->
                                   <div class="tile-body">
                                     <form id="defaultForm" class="form-horizontal" name="info" action="save_subject.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                      <label class="control-label col-md-3">Reporting  Date</label>
                                      <div class="col-md-8">
                                        <input class="form-control" type="text" placeholder="Accounting Date" name="report_date" id="report_date">
                                      </div>
                                    </div>
        ...
        var formData = new FormData(form);
          ...
          if(filePath !='')
          {
            ...
            if(allowedExtensions.exec(filePath))
            {
                ...
                swal({
                title: "DO YOU WANT TO CRETE THIS SUBJECT FILE ??",
                icon: "success",
                buttons: true,
                dangerMode: true,
                })
                .then((yes) => {
                  if (yes) {
                   $('.page_loader').show();
                      ...
                      $.ajax({
                          url:'check_subject_imported_data.php',
                          type:'POST',
                          data:formData,
                          contentType: false, 
                          processData: false,
                    ...
                    swal("YOUR SUBJECT FILE NOT IMPORT YET!");
                  }
                });
