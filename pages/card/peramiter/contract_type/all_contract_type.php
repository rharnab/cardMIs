...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Card | All Contract type</title>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>All Contract Type</h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Utility</a></li>
                        <li><a href="#">Paremeter</a></li>
                        <li class="active">all contract Type</li>
                    </ol>
                </section>
                            ...
                            <div class="box">
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped table-hover table-responsive">
                                        ...
                                        <tbody>
                                                <?php 
                                                    $sql = mysql_query("SELECT * from contract_types where description<> '' ");
                                                    $sl=1;
                                                    while($result = mysql_fetch_array($sql))
                                                    {
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>  
                                                                    <button type="button"  id="<?php echo $result['contr_type_id'] ?>" class="btn btn-primary edit_contract">Edit</button>
                                                                </td>
                                                            </tr>
                                                        <?php
                                                    }
                ...
                <!-- modal -->
                    ...
                    <h4 class="modal-title" id="modalLabelLarge">Edit Contract Type</h4>
                    </div>
        ...
        <script type="text/javascript">
            ...
            $('.edit_contract').on('click', function(){
                ...
                $.ajax({
                    type:'Post',
                    data:{'id':id},
                    url:"fetch_contract_type.php",
                    dataType:"json",
                    success:function(data)
                    {
                       $('#value').val(data.value);
                       $('#description').val(data.description);
                       $('#hidden_id').val(data.contr_type_id);
