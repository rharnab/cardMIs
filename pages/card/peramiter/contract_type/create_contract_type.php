...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Card | Create Contract Type</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10" style="left: 0px; top: 0px">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form method="post" action="save_contract_type.php">
                                    <div class="box-body">
                                    ...
                                    <div class="box-footer">
                                        <button id="submitBtn"  class="btn btn-primary" style="margin-left:15px">Create Contract Type</button>
                                    </div>
                                </form>
                            </div>
                        </div><!--/.col (left) -->
