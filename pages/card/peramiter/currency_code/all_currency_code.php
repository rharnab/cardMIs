        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                            ...
                            <div class="box">
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped table-hover table-responsive">
                                        ...
                                        <tbody>
                                                <?php 
                                                    $sql = mysql_query("SELECT * from currency_codes where description<> '' order by currency_code_id desc ");
                                                    $sl=1;
                                                    while($result = mysql_fetch_array($sql))
                                                    {
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>  
                                                                    <button type="button"  id="<?php echo $result['currency_code_id'] ?>" class="btn btn-primary edit_contract">Edit</button>
                                                                </td>
                                                            </tr>
                                                        <?php
                                                    }
                ...
                <!-- modal -->
                    ...
                    <h4 class="modal-title" id="modalLabelLarge">Edit Currency Code</h4>
                    </div>
        ...
        <script type="text/javascript">
            ...
            $('.edit_contract').on('click', function(){
                ...
                $.ajax({
                    type:'Post',
                    data:{'id':id},
                    url:"fetch_currency_code.php",
                    dataType:"json",
                    success:function(data)
                    {
                       $('#value').val(data.value);
                       $('#description').val(data.description);
                       $('#hidden_id').val(data.currency_code_id);
