...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Card | Create Contract Phase</title>
		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>Create Contract Phase</h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Utility</a></li>
                        <li class="active">Parameter</li>
                        <li class="active">Contract Phase</li>
                    </ol>
                </section>
                <!-- Main content -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10" style="left: 0px; top: 0px">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form method="post" action="save_contract_phase.php">
                                    <div class="box-body">
                                    ...
                                    <div class="box-footer">
                                        <button id="submitBtn"  class="btn btn-primary" style="margin-left:15px">Create Contract Phase</button>
                                    </div>
                                </form>
                            </div>
                        </div><!--/.col (left) -->
